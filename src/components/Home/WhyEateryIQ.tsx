            ...
            <div className="space-y-4 text-left w-full">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    Operational insights to reduce waste and streamline
                    processes
                  </span>
                </li>
              </ul>
            ...
            <div className="space-y-4 text-left w-full">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    Third-party delivery promo planner (Uber Eats, DoorDash,
                    etc.)
                  </span>
                </li>
                <li className="flex gap-2">
            ...
            <div className="space-y-4 text-left w-full">
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li className="flex gap-2">
                  <span className="text-foreground">•</span>
                  <span>
                    Operations review with AI-generated efficiency
                    recommendations
                  </span>
                </li>
                <li className="flex gap-2">
